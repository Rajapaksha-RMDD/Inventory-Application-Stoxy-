      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          int totalQuantity = allDocs.fold<int>(
            0,
            (sum, doc) => sum + _parseQty(doc['quantity']),
          );
                        ...
                        Expanded(
                          child: GestureDetector(
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const CustomerLowStockScreen(),
                              ),
                            ),
                  ...
                  builder: (context, invSnap) {
                    ...
                    final filteredDocs = productDocs.where((doc) {
                      ...
                      final name = (pData['name'] as String? ?? '')
                          .toLowerCase();
                      final supplier = (pData['supplierName'] as String? ?? '')
                          .toLowerCase();
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return _InventoryProductCard(
                                ...
                                isLow: isLow,
                                hasChange: _pendingChanges.containsKey(
                                  productName,
                                ),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                "Stock: ${widget.currentQty}",
                style: TextStyle(
                  color: widget.currentQty < 5 ? Colors.red : Colors.black54,
                  fontSize: 12,
                ),
              ),
            ],
              ...
              isSending
                  ...
                  : ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        try {
                          User? user = FirebaseAuth.instance.currentUser;
                          DocumentSnapshot uDoc = await FirebaseFirestore
                              .instance
                              .collection('users')
                              .doc(user?.uid)
                              .get();
